...
function(BoostSource boost_VERSION urlout hashout)
    if (boost_VERSION STREQUAL "1.67.0")
        set(${urlout} "https://boostorg.jfrog.io/artifactory/main/release/1.67.0/source/boost_1_67_0.tar.bz2" PARENT_SCOPE)
        set(${hashout} "SHA256=2684c972994ee57fc5632e03bf044746f6eb45d4920c343937a465fd67a5adba" PARENT_SCOPE)
...
function(RequireBoost )
    ...
    if (NOT boost_POPULATED)
        message(STATUS "[dependencies] [boost] downloading  ${boost_URL} expecting hash ${boost_HASH}")
